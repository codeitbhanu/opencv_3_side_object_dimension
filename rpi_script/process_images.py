...
def process(img_dict, config_data, fport, rport, tport, clr_profile):
    ...
    dim_ret = detect_dimensions.get_whl(img_dict,config_data,  fport, rport, tport)
    logging.debug (dim_ret)

    
    # enable_logging.debug()

    clr_ret = detect_color.get_color(img_dict,config_data,fport, rport, tport, profile=clr_profile)
